...
select contactName, City from customer order by ContactName asc;
select distinct country from customer;
select contactname from customer where country = 'Mexico';
select customerName, contactName from customer where city = 'Berlin' and country = 'Germany';
select customerName, contactName from customer where country not like 'Germany'
select ContactName from customer where ContactName like '%Moreno%';
select * from customer where PostalCode is null; 
select * from customer order by city asc;
select * from customer order by ContactName asc LIMIT 3;
